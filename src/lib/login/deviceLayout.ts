...
export const DEFAULT_DEVICE_LAYOUTS: Record<DeviceProfileKey, Record<string, string>> = {
  desktop: {
    ...
    "--login-popup-left": "74%",
    "--login-popup-top": "60%",
    "--login-popup-width": "28vw",
    "--login-popup-height": "30%",
    "--login-popup-max-width": "520px",
    "--login-popup-max-height": "72dvh",
    "--login-close-top": "calc(60% + min(20vh, 160px))",
  },
  "iphone-portrait": {
    "--login-bg-size": "180%",
    "--login-bg-size-x": "180%",
  ...
  "ipad-portrait": {
    ...
    "--login-ipad-text-line-height": "1.56",
    "--login-left-top": "36%",
    "--login-left-left": "24%",
    "--login-left-width": "30%",
    "--login-left-height": "26%",
    "--login-right-top": "34%",
    "--login-right-left": "10%",
    "--login-right-mode-top": "30%",
    "--login-right-width": "30%",
    "--login-right-height": "24%",
    "--login-popup-left": "74%",
    "--login-popup-top": "60%",
    "--login-popup-width": "44vw",
    "--login-popup-height": "30%",
    "--login-popup-max-width": "460px",
    "--login-popup-max-height": "74dvh",
    "--login-close-top": "calc(60% + min(20vh, 150px))",
  },
  "ipad-landscape": {
    "--login-bg-size": "100%",
    "--login-bg-size-x": "100%",
    ...
    "--login-ipad-text-size": "0.92rem",
    "--login-ipad-text-line-height": "1.48",
    "--login-left-top": "36%",
    "--login-left-left": "24%",
    "--login-left-width": "30%",
    "--login-left-height": "26%",
    ...
    "--login-popup-left": "74%",
    "--login-popup-top": "58%",
    "--login-popup-width": "34vw",
    "--login-popup-height": "30%",
    "--login-popup-max-width": "460px",
    "--login-popup-max-height": "74dvh",
    "--login-close-top": "calc(58% + min(20vh, 150px))",
  },
};
...
const PERCENT_LIMITS: Record<string, [number, number]> = {
  ...
  "--login-left-top": [-150, 300],
  "--login-left-left": [-300, 500],
  "--login-left-width": [8, 100],
  "--login-left-height": [8, 220],
  "--login-right-top": [-150, 300],
  "--login-right-left": [-300, 500],
  "--login-right-mode-top": [-150, 300],
  "--login-right-width": [8, 100],
  "--login-right-height": [8, 220],
  "--login-popup-left": [10, 95],
  "--login-popup-top": [10, 95],
  "--login-popup-height": [5, 220],
};
...
function sanitizeKeyedVar(profile: DeviceProfileKey, key: string, value: string) {
  ...
  if (key === "--login-desktop-text-scale") {
    return clampUnitless(value, 0.6, 4);
  }
